...
export function API_grouplist(id, param) {
    const result = parseQueryString(process.env.VUE_APP_API_PATH_CLASSIFY_GROUP_LIST, param);
...
export function API_groupmanage(id, param) {
    const result = parseQueryString(process.env.VUE_APP_API_PATH_CLASSIFY_GROUP_MANAGE, param);
