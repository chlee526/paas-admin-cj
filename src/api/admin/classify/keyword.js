...
export function API_keywordlist(id, param) {
    const result = parseQueryString(process.env.VUE_APP_API_PATH_CLASSIFY_LIST, param);
...
export function API_keywordmanage(id, param) {
    const result = parseQueryString(process.env.VUE_APP_API_PATH_CLASSIFY_MANAGE, param);
