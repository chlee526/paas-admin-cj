...
import { API_keywordlist } from '@/api/admin/dictionary/keyword';
import CompKeywordList from '@/components/keyword_boilerplate/comp_list';

export default {
    name: 'comp-dictionary-keyword-list',
    ...
    methods: {
        ...
        async fetchData(excel) {
            ...
            const isSelected = ['seq', 'attribute'].every((key) => Object.keys(this.selectedGrp).includes(key));
            if (!isSelected) {
