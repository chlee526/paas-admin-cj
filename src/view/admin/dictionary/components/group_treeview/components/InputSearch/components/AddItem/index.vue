    ...
    <comp-filter-grp ref="filterGrp" :disableConfirmBtn="inputDisable" class="is-small btnAdd" @confirm="registItem" @close="resetName" @cancel="resetName" @open="resetName" pos="R">
        ...
        <template v-slot:items>
            <dl>
                ...
                <dd>
                    <comp-input-box ref="inputBox" class="is-small" placeholder="기사 주제 입력" v-model="input.name" :forbiddenChars="forbiddenChars" :validation="getWarnig" focusResetVisible @enter="registItem" @focus="isBlur = false" @blur="blurIdInput"></comp-input-box>
