...
import { API_keywordlist } from '@/api/admin/replace';
import CompKeywordList from '@/components/keyword_boilerplate/comp_list';

export default {
    name: 'comp-replace-list',
    extends: CompKeywordList,
    data() {
        return {
            colOpts: [
                { code: 'find_keyword', name: '찾을 키워드' },
                { code: 'replace_keyword', name: '치환 키워드' },
    ...
    methods: {
        ...
        exportExcel() {
            ...
            worker.postMessage({ list: this.excelDownList, columns: setColnameHeader, sheetName: '관리자_키워드_치환' });
